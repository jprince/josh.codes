...
import kanburnPreview from '@src/img/portfolio/kanburn/loading.gif'
    ...
    return (
      <Grid container className="home">
        ...
        <Grid container className="portfolio">
          ...
          <Grid item xs={12}>
            <Link to="/portfolio">
              <Grid container spacing={24}>
                <Grid item xs={4}>
                  <Img sizes={images.analyticsPreview.sizes} alt="Thumbnail image of Arcadia Analytics" />
                </Grid>
                <Grid item xs={4}>
                  <img className="gif" src={kanburnPreview} alt="Thumbnail image of Kanburn" />
                </Grid>
                <Grid item xs={4}>
                  <Img sizes={images.kingsCornerPreview.sizes} alt="Thumbnail image of Kings Corner" />
                </Grid>
              </Grid>
            </Link>
          </Grid>
        ...
        <Grid container className="professional-experience">
          ...
          <Grid item className="experience-arcadia" xs={6}>
            <Img resolutions={images.arcadiaLogo.resolutions} alt="Arcadia.io logo" />
            <DetailModal
          ...
          <Grid item className="experience-ahp" xs={6}>
            <Img resolutions={images.ahpLogo.resolutions} alt="AHP logo" />
            <DetailModal
        ...
        <Grid container className="education">
          ...
          <Grid item className="education-bu" xs={12}>
            <Img resolutions={images.buLogo.resolutions} alt="Boston University logo" />
            <DetailModal class="education-bu-modal" modalTitle="Boston University">
        ...
        <Grid container className="technical-skills">
          ...
          <Grid item xs={11}>
            ...
            <Img sizes={images.skillsChart.sizes} alt="Graphic representing technical experience and expertise" />
          </Grid>
          <Grid item xs={1} className="button-wrapper">
            <DetailModal class="skills-chart-modal" modalTitle="Technical Skills">
              <Grid container>
                <Grid item xs={4}>
